define({
    root : {
        ...
        ghg_overview: 'Regional Overview Tool',
        ...
        ghg_overview_button: 'Go to the Regional Overview Tool',
        ...
        ghg_quality_button: 'Go to the QA-QC and Verification',
        ...
        ghg_indicators_button: 'Go to the Indicators',
        ghg_data: 'Georeferenced data',
        ghg_data_description: 'The tool allows users to access and examine global georeferenced data used to estimate emissions of specific agriculture and land use categories in the FAOSTAT Emissions database. The data are available for download at country level.',
        ghg_data_button: 'Go to the Georeferenced data'
    },
    F : true,
    S : true
});